...
export const getPayrollMonthSettings = (year, month) =>
  client.get(`/payroll/month-settings/${year}/${month}`).then((r) => r.data)
export const putPayrollMonthSettings = (year, month, data) =>
  client.put(`/payroll/month-settings/${year}/${month}`, data).then((r) => r.data)

export const getPayrollRoleDefaults = () => client.get('/payroll/role-defaults').then((r) => r.data)
export const putPayrollRoleDefault = (role, data) =>
  client.put(`/payroll/role-defaults/${encodeURIComponent(role)}`, data).then((r) => r.data)
