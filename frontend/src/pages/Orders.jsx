...
import { Plus, Clock, Utensils, ChefHat, Ban, Pencil, User, Truck, Trash2, Download } from 'lucide-react'
...
import { getOrders, createOrder, updateStatus, updateOrderItems, deleteOrder } from '../api/orders'
...
// ──────────────────────────────────────────────────────────────────────────────
function OrderCard({ order, onAction, onEditItems, onDelete, t, canEdit, canStart, usersMap }) {
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-4 space-y-3">
      ...
      <ul className="text-sm text-slate-600 space-y-0.5">
        {order.details.map((d) => (
          <li key={d.item_id} className="flex justify-between">
