...
export default function Tables() {
  ...
  const discountVal = (() => {
    ...
    if (discountType === 'fixed') return Math.min(amt, billTotal)
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-border px-4 py-3 space-y-2">
                ...
                {['fixed', 'pct'].map((type) => (
                  <label key={type} className="flex items-center gap-1.5 text-sm cursor-pointer">
                    <input
                      ...
                      onChange={() => { setDiscountType(type); setDiscountAmount('') }}
              ...
              <input
                ...
                placeholder={discountType === 'fixed' ? t('tables.discount_amount_ph') : t('tables.discount_pct_ph')}
